...
resource "azurerm_virtual_machine" "client" {
  ...
  os_profile_linux_config {
      ssh_keys {
        key_data = file(var.admin_ssh_key) #var.admin_ssh_key
...
#       ],
#       "commandToExecute": "bash installCAPI.sh ${var.admin_username} ${var.spn_client_id} ${var.spn_client_secret} ${var.spn_tenant_id} ${var.vm_name} ${data.azurerm_resource_group.rg.location} ${var.storage_account_name} ${var.workspace_name}"
#     }
# PROTECTED_SETTINGS
# }
